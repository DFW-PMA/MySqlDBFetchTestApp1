...
class JmUserDefaults: NSObject
{
    ...
    @objc func getObjCObjectForKey(_ forKey:NSString = "") -> Any?
    {
        ...
        self.xcgLogMsg("\(sCurrMethodDisp) Invoked  - 'forKey' is [\(forKey)]...")
        ...
        if (sSuppliedForKey.count < 1)
        {
            ...
            self.xcgLogMsg("\(sCurrMethodDisp) Exiting - 'sSuppliedForKey' was None or empty - Error!...")
        ...
        self.xcgLogMsg("\(sCurrMethodDisp) Exiting - 'sSuppliedForKey' is [\(sSuppliedForKey)]...")
